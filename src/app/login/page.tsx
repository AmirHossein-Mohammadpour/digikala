      ...
      >
        ...
        <div className={`flex flex-col gap-6`}>
          ...
          <div className={`flex flex-col gap-1`}>
            <input
              type="text"
              className={`border outline-none p-3 text-base rounded-lg border-neutral-400 text bg-amber-50 text-black`}
            />
            <p className={`text-primary`}>لطفا این قسمت را خالی نگذارید</p>
          </div>
          <button
            className={`bg-primary text-white p-3 text-base font-bold rounded-lg`}
          >
            ورود
          </button>
          <p className={``}>
